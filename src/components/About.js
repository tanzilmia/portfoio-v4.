        ...
        <div className='flex flex-col xl:flex-row gap-24'>
          ...
          <div className='flex flex-col items-center text-center lg:items-start lg:text-left'>
            <div className='flex flex-col'>
              ...
              Hi there,I'm Md Tanzil Mia, and I Complete diploma in engineering from the Tangail polytechnic institute in Computer Science and Engineering in 2020. My current interests are in front-end development, and I enjoy using React JS to create beautiful and performant products with delightful user experiences.I refer to myself as a "passionate front-end developer" who loves coding and web platforms.<br />
                <br />
